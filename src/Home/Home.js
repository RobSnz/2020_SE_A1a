...
class Home extends React.Component {
  constructor(props) {
    ...
    this.state = {
      //keeps track of state of users current search
      search: "",
      ...
      constraintView = (
        <ListGroup>
          {this.state.constraints.map((item) => (
            <InputGroup
              className="mb-3"
              style={{ width: "150%", alignItems: "left" }}
            >
              <ListGroup.Item>
              ...
              <InputGroup.Append>
                <IconButton
                  onClick={() => this.removeConstraintHandler(item.id)}
                  aria-label="remove"
          ...
          <div className="">
            <div className="input-box">
              ...
              <InputGroup className="mb-3">
                ...
                <InputGroup.Append>
                  <IconButton>
                    <Link to={{ pathname: "/Results", data: this.state }}>
                      <SearchIcon
                        aria-label="search"
                        style={{
                          float: "right",
              ...
              <Form>
                <Form.Row>
                  <Form.Group as={Col} controlId="dateFromPicker">
                    <Form.Label style={{ float: "left", paddingRight: "10px" }}>
                      DATE FROM
                    </Form.Label>
                    <DatePicker
                  ...
                  <Form.Group as={Col} controlId="dateToPicker">
                    <Form.Label style={{ float: "left", paddingRight: "50px" }}>
                      DATE TO
                    </Form.Label>
                    <DatePicker
                      className="dateFontSize"
              ...
              <Form>
                <Form.Row>
                  ...
                  <Form.Group as={Col} controlId="formGridOperator">
                    ...
                    <Form.Control
                      as="select"
                      value={this.state.selectOperator}
                  ...
                  <Form.Group as={Col} controlId="formGridValue">
                    ...
                    <InputGroup className="mb-3">
                      ...
                      <InputGroup.Append>
                        <IconButton
                          onClick={this.addConstraintHandler}
                          aria-label="add"
                          style={{ float: "right", margin: "-5px 0 0 0" }}
                        >
                          <AddIcon />
